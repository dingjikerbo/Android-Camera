...
public class MovieEncoder implements Runnable {
    ...
    public MovieEncoder(Context context) {
        mContext = context;
    }
    ...
    public void startRecording(EncoderConfig config) {
        Log.v(TAG, String.format("%s startRecording", getClass().getSimpleName()));
    ...
    public void stopRecording() {
        Log.v(TAG, String.format("%s stopRecording", getClass().getSimpleName()));
     ...
     */
    public void frameAvailable(byte[] data, SurfaceTexture st) {
        synchronized (mReadyFence) {
            if (!mReady) {
                return;
            }
        ...
        if (mYUVBuffer == null) {
            mYUVBuffer = ByteBuffer.allocateDirect(1280 * 720 * 3 / 2)
    ...
    private void handleStartRecording(EncoderConfig config) {
        prepareEncoder(config.mMuxer, config.mEglContext);
    }
    ...
    private void handleFrameAvailable(ByteBuffer buffer, long timestampNanos) {
        ...
        mTextureProgram.setUniforms(buffer.array());
    ...
    private void prepareEncoder(AndroidMuxer muxer, EGLContext sharedContext) {
